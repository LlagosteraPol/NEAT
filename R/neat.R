...
#' @description Network Event Analysis Tools (NEAT), is a project that provides extra tools 
#' to study and analyze the events that occur in a network, its characteristics, and effects.
